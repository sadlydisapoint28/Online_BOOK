...
$completed_bookings = $pdo->query($query);
?>
...
<head>
    ...
    <title>Completed Bookings - Boat Rental System</title>
...
<body class="bg-gray-100">
            ...
            <nav class="mt-8">
                <div class="px-4 space-y-2">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="pending_bookings.php" class="flex items-center px-6 py-3 text-indigo-200 hover:bg-indigo-800 rounded-lg transition-colors duration-200">
                            <i class="fas fa-clock mr-3"></i>
                            Pending
                        </a>
                        <a href="completed_bookings.php" class="flex items-center px-6 py-3 text-white bg-indigo-800 rounded-lg">
        ...
        <div class="flex-1 overflow-auto">
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between px-6 py-4">
                    <h2 class="text-xl font-semibold text-gray-800">Completed Bookings</h2>
                </div>
            </header>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php while ($booking = $completed_bookings->fetch()): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <button class="text-blue-600 hover:text-blue-900 mr-3" onclick="viewDetails(<?php echo $booking['id']; ?>)">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="text-green-600 hover:text-green-900" onclick="generateReceipt(<?php echo $booking['id']; ?>)">
    ...
    <script>
        function viewDetails(bookingId) {
            // Add AJAX call to view booking details
